(function () {
    ...
    BR.conf.baseLayers = {
        ...
        'Singletrail Map': 'https://singletrail-map.ch/styles/singletrailmap/{z}/{x}/{y}.png',
    };

    BR.conf.overlays = {
        'MTB Singletrails': 'https://singletrail-map.ch/styles/mtb/{z}/{x}/{y}.png',
        'Potential MTB Singletrails': 'https://singletrail-map.ch/styles/mtb_potential/{z}/{x}/{y}.png',
        'Trailforks Heatlines': 'https://singletrail-map.ch/styles/trailforks_heatmap/{z}/{x}/{y}.png',
    };
